...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2012 - 2016}{IPB University, Biosystem Engineering {\normalfont }}{}{
...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{2017}{The 3rd winner of go-hackaton 2017, held by Go-jek}
...
\begin{twenty}
	\twentyitem{Qoala.id}{[2019-] Computer Vision for Automated Claim}{}{Working with computer vision algorithms ex, object detection, segmentation, classification, keypoint detection, and face recognition for building an automate insurance assesment by videos or images. Our products are: \\
		
	1. Automate assesment of smartphone screen protection using video \\
    2. Automate assesment of vehicle body protection using images \\
	3. South East Asia ID Cards OCR and face comparison \\

    Theese projects already integrated into Qoala ecosystem and realesed as products. For the technologies, we are using both GCP (app-engine, AI-platform, kubernetes engine, pub/sub, storage, datastore, bigquery, mysql, GCR, and dataflow) and AWS (Lambda, gateway, sagemaker, s3, ECR, and SNS). Currently, we also finish the development of our automate model training for both GCP and AWS. }\\
	
	\twentyitem{-Hobby-}{[2018-2019] Building a simple-tensor: Simplification of tensorflow operations}{}{
	This project is aiming to create an opensource python package for simplifying the usage of tensorflow, especially for tensor operations, losses, and architectures. The package also provides some computer vision algorithms, ex:\\
    ...
    Github: \href{https://github.com/fatchur/Simple-Tensor} {Github Link}, Pypi:\href{https://pypi.org/project/simple-tensor/} {How to install}\\
    }\\
\end{twenty}
